...
public class MethodExercisesTest {
    ...
    public void findCommonElementsTest() {
        Assert.assertEquals(Arrays.toString(new int[]{8, 9}), findCommonElements(new int[]{1, 2, 3, 4, 5, 67, 8, 9}, new int[]{6, 7, 8, 9}));
        Assert.assertEquals(Arrays.toString(new int[]{2, 3, 99, 123}), findCommonElements(
        ...
        Assert.assertEquals(Arrays.toString(new int[]{1, 456, 654, 901}), findCommonElements(new int[]{456, 123, 654, 1, 23, 23, 34, 34, 18, 901}, new int[]{476, 1, 343, 456, 901, 809, 812, 654, 398163, 0, 285}));
    }
}
